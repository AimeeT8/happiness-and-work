...
fig.set_facecolor("#E5E5E5") #background color
...
# print(f"Countries with the largest amount of happeiness: {happiness_average_per_country.nlargest(10)}")
# print(f"Countries with the smallest amount of happiness: {happiness_average_per_country.nsmallest(10)}")
